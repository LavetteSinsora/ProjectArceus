"""exp_013_1 RND+ICM ("OCC") single-run CLI.
    ...
    uv run python -m JEPA.experiments.exp_013_headline_experiment.exp_013_1b_leaky_rnd_on_icm_phi.run \
...
def main():
    ...
    p.add_argument("--phi-mode", choices=["icm", "frozen", "pixel"], default=None,
                   help="RND ruler: ICM learned features (icm), a fixed random encoder "
