"""
Exp-002 evaluation: runs N episodes with the trained policy and reports completion rate.

Usage:
    cd "Code Repo" && uv run python -m JEPA.experiments.exp_002_perceiver_flow_jepa.eval
    cd "Code Repo" && uv run python -m JEPA.experiments.exp_002_perceiver_flow_jepa.eval --checkpoint checkpoints/step_050000.pt --episodes 20
"""
...
from JEPA.experiments.exp_002_perceiver_flow_jepa.reward_shaping import is_end_of_life
