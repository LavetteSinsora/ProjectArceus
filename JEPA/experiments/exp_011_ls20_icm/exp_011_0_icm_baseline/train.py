"""Train exp_011_0 (ICM + PPO on real LS20).

    uv run python -m JEPA.experiments.exp_011_ls20_icm.exp_011_0_icm_baseline.train
    uv run python -m JEPA.experiments.exp_011_ls20_icm.exp_011_0_icm_baseline.train --smoke
    uv run python -m JEPA.experiments.exp_011_ls20_icm.exp_011_0_icm_baseline.train --seed 1
"""
