...
Run: uv run python -m JEPA.experiments.exp_013_sparse_exploration.probes.entropy_sweep --which h5
"""
...
from JEPA.experiments.exp_013_sparse_exploration.probes.reward_mode_control import run
