"""
Debug episode runner for exp_003_2_action_pred_no_ema.
...
Usage:
    ...
    uv run python JEPA/experiments/exp_003_2_action_pred_no_ema/debug_runner.py \\
        JEPA/experiments/exp_003_2_action_pred_no_ema/checkpoints/step_005000.pt
"""
...
def run_debug_episode(checkpoint_path: str,
    ...
    from JEPA.experiments.exp_003_2_action_pred_no_ema.models import CAPABILITIES
    out = {
        "checkpoint":       ckpt_name,
        "checkpoint_step":  ckpt_step,
        "experiment":       "exp_003_2_action_pred_no_ema",
...
if __name__ == "__main__":
    _ckpt = (sys.argv[1] if len(sys.argv) > 1
             else "JEPA/experiments/exp_003_2_action_pred_no_ema/checkpoints/step_005000.pt")
