"""
Debug episode runner for exp_006_interleaved_freezing.
...
Usage:
    cd "Code Repo"
    uv run python JEPA/experiments/exp_006_interleaved_freezing/debug_runner.py \\
        JEPA/experiments/exp_006_interleaved_freezing/checkpoints/step_005000.pt
"""
...
def run_debug_episode(checkpoint_path: str,
    ...
    for t in range(max_steps):
        ...
        timesteps.append({
            ...
            "flow_loss":              flow_loss,
            # ── Action predictor (NEW for exp_006) ────────────────────────
    ...
    from JEPA.experiments.exp_006_interleaved_freezing.models import CAPABILITIES
    out = {
        "checkpoint":       ckpt_name,
        "checkpoint_step":  ckpt_step,
        "experiment":       "exp_006_interleaved_freezing",
...
if __name__ == "__main__":
    _ckpt = (sys.argv[1] if len(sys.argv) > 1
             else "JEPA/experiments/exp_006_interleaved_freezing/checkpoints/step_005000.pt")
