"""
Exp-003-2 evaluation — N-episode completion-rate readout.
...
def eval_policy(cfg: Config, checkpoint_path: str, n_episodes: int,
        ...
        while True:
            ...
            with torch.no_grad():
                ...
                action_idx, _, _ = policy.act(
                    h_current.squeeze(0), env.available_actions
                )
