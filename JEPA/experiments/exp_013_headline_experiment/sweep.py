...
Split the work across two machines by environment, e.g.:
    # Colab (forward envs):
    !python -m JEPA.experiments.exp_013_headline_experiment.sweep --games ls20 tu93 --save-dir /content/drive/MyDrive/exp013_results
    # Mac (last envs):
    uv run python -m JEPA.experiments.exp_013_headline_experiment.sweep --games g50t re86 --save-dir ~/exp013_results
