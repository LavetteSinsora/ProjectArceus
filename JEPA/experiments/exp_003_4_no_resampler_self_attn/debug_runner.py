"""
Debug episode runner for exp_003_4_no_resampler_self_attn.
...
Per-timestep data collected (same as exp_003_0 plus action predictor + dual-path reward):
  ...
  perceiver_cross_attn_r0/r1  (no self-attn — removed in exp_003_4)
...
Usage:
    ...
    uv run python JEPA/experiments/exp_003_4_no_resampler_self_attn/debug_runner.py \\
        JEPA/experiments/exp_003_4_no_resampler_self_attn/checkpoints/step_005000.pt
"""
...
def run_debug_episode(checkpoint_path: str,
    ...
    for t in range(max_steps):
        ...
        # exp_003_4: rounds are cross-attn only, so inter_r0 == ca_out_r0.
        inter_r0_cap     = [None]  # output of Round 0 (= queries after cross-attn)
        ca_out_r0_cap    = [None]  # queries after Round 0 cross-attn
        ca_out_r1_cap    = [None]  # queries after Round 1 cross-attn
        ...
        timesteps.append({
            ...
            "flow_loss":              flow_loss,
            # ── Action predictor (NEW for exp_003_2) ────────────────────────
    ...
    from JEPA.experiments.exp_003_4_no_resampler_self_attn.models import CAPABILITIES
    out = {
        "checkpoint":       ckpt_name,
        "checkpoint_step":  ckpt_step,
        "experiment":       "exp_003_4_no_resampler_self_attn",
...
if __name__ == "__main__":
    _ckpt = (sys.argv[1] if len(sys.argv) > 1
             else "JEPA/experiments/exp_003_4_no_resampler_self_attn/checkpoints/step_005000.pt")
    ...
    print(f"Perceiver cross-attn r0 shape: {len(t0['perceiver_cross_attn_r0'])}×{len(t0['perceiver_cross_attn_r0'][0])}")
