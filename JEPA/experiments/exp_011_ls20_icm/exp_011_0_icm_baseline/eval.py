"""Evaluate an exp_011_0 checkpoint over fresh LS20 episodes (policy only — the
ICM is not used at inference, exactly as in the paper).

    uv run python -m JEPA.experiments.exp_011_ls20_icm.exp_011_0_icm_baseline.eval \
        --checkpoint .../exp_011_0_icm_baseline/checkpoints/step_00001024.pt
"""
