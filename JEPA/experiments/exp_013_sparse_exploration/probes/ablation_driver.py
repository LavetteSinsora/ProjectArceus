...
Usage:
  uv run python JEPA/experiments/exp_013_sparse_exploration/probes/ablation_driver.py \
...
from JEPA.experiments.exp_013_sparse_exploration.exp_013_1_rnd_icm.trainer import train
