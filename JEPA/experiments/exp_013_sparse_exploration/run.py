...
--------
    ...
    uv run python -m JEPA.experiments.exp_013_sparse_exploration.run \
...
from JEPA.experiments.exp_013_sparse_exploration.shared.config import Config, GAME_N_ACTIONS
from JEPA.experiments.exp_013_sparse_exploration.shared.trainer import train
