...
from JEPA.experiments.exp_013_headline_experiment.exp_013_1b_leaky_rnd_on_icm_phi.config import (
...
@dataclass
class Config(_Base):
    exp_dir: str = "JEPA/experiments/exp_013_headline_experiment/exp_013_2_additive_rnd_icm"
