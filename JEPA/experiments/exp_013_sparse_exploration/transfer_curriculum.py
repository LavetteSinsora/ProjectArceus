...
Timer-mask + all exp_013_1 fixes apply.
    ...
    uv run python -m JEPA.experiments.exp_013_sparse_exploration.transfer_curriculum \
...
from .exp_013_1_rnd_icm.config import Config, GAME_N_ACTIONS
from .exp_013_1_rnd_icm.rnd_phi import RNDPhi
from .exp_013_1_rnd_icm.trainer import (
...
def run_curriculum(game: str, seed: int, levels: list[int], caps: list[int]) -> dict:
    ...
    exp_dir = _repo_root() / "JEPA/experiments/exp_013_sparse_exploration/transfer_runs"
