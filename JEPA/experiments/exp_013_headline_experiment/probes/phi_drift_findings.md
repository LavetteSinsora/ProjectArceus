...
- Script: `JEPA/experiments/exp_013_headline_experiment/probes/phi_drift_probe.py`
- Raw numbers: `JEPA/experiments/exp_013_headline_experiment/probes/phi_drift_results.json`
- Figure: `JEPA/experiments/exp_013_headline_experiment/probes/phi_drift.png`
- Re-run: `uv run python JEPA/experiments/exp_013_headline_experiment/probes/phi_drift_probe.py`
