...
Run (ONE process; MPS): uv run python -m \
  JEPA.experiments.exp_013_headline_experiment.probes.signal_redundancy
"""
...
from JEPA.experiments.exp_013_headline_experiment.exp_013_2_additive_rnd_icm.trainer import _SignalNorm
