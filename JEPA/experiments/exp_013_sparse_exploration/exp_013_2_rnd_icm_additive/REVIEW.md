...
Read-only review. No code modified. Scope: `exp_013_2_rnd_icm_additive/{config,trainer,run}.py`,
reusing `exp_013_1_rnd_icm/{trainer,rnd_phi,config}.py` and `exp_011_ls20_icm/shared/icm.py`.
