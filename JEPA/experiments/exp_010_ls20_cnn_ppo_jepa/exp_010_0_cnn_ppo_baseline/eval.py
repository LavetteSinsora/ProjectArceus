"""Evaluate an exp_010_0 checkpoint over fresh LS20 episodes.

    uv run python -m JEPA.experiments.exp_010_ls20_cnn_ppo_jepa.exp_010_0_cnn_ppo_baseline.eval \
        --checkpoint JEPA/experiments/exp_010_ls20_cnn_ppo_jepa/exp_010_0_cnn_ppo_baseline/checkpoints/step_00001024.pt
"""
