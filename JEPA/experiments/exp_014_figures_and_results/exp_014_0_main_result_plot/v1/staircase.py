...
band at each riser. The dashed gray line is the uniform-random policy reference.
  ...
  uv run python JEPA/experiments/exp_014/exp_014_0_main_result_plot/staircase.py
...
RUNS = EXPERIMENTS / "exp_013_headline_experiment" / "runs"  # baseline icm/rnd calibration
