"""exp_013_2 ADDITIVE RND+ICM single-run CLI.

    uv run python -m JEPA.experiments.exp_013_headline_experiment.exp_013_2_additive_rnd_icm.run \
        --game ls20 --level 1 --seed 0 --max-env-steps 500000

    # smoke:
    uv run python -m JEPA.experiments.exp_013_headline_experiment.exp_013_2_additive_rnd_icm.run \
        --game ls20 --level 1 --seed 0 --smoke
"""
...
def main():
    p = argparse.ArgumentParser(description="exp_013_2 additive RND+ICM run")
